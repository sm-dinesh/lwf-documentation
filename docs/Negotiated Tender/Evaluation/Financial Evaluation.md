---
id: negotiated-tender-financial-evaluation
title: Negotiated Tender – Financial Evaluation
...
- **All the criterion are assigned scores and no rejection reason is checked** to accept a bid.
- **Evaluator Remarks** is required prior before submitting the evaluation.

## Rejection Rules

- At least **one rejection criterion is checked** to reject a bid.
...
The evaluation is divided into two tabs.
