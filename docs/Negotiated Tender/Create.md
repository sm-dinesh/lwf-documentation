...
1. **Name**  
   Enter a descriptive tender name that clearly identifies the procurement
...
5. **Terms and Conditions**  
   Define the rules, requirements, and obligations for suppliers
...
15. **Save as Draft**  
    Click **Draft** to save without publishing (allows further edits)

16. **Publish Tender**  
    Click **Save** to publish the tender and make it active
