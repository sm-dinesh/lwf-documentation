...
### 3. Send for Review
- Sends the award Templates for approval.
...
1.  Basic Details: includes summary about Award Template
   2.  Offer Letter:
      - downloads templates uploaded by Vendor
        
3. Activity log: display all activities of award templates
4. Approve:
- Reviewer can:
