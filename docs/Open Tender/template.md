...
The **Template Management** feature allows users to manage, edit, and download document templates associated with an Open Tender.  
...
1. Open the Open Tender **Edit Page**  
