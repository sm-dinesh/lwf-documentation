...
# Criterios de licitación negociada

El proceso es similar al de la licitación abierta.

## Criterios administrativos

- Mismos campos y reglas que los administrativos de la licitación abierta

![Criterios administrativos](/img/settings/criteria/settings_open_tender_administrative_create.png)

## Criterios técnicos

- Mismos campos y reglas que los técnicos de la licitación abierta

![Criterios técnicos](/img/settings/criteria/settings_open_tender_technical_create.png)

## Criterios financieros

- Mismos campos y reglas que los financieros de la licitación abierta
...
- **Crear criterio** – Guardar el criterio
