...
Le processus est similaire à celui de l'appel d'offres ouvert.

## Critères administratifs

- Mêmes champs et règles que l'administration de l'appel d'offres ouvert

![Critères administratifs](/img/settings/criteria/settings_open_tender_administrative_create.png)

## Critères techniques

- Mêmes champs et règles que la technique de l'appel d'offres ouvert

![Critères techniques](/img/settings/criteria/settings_open_tender_technical_create.png)

## Critères financiers

- Mêmes champs et règles que les finances de l'appel d'offres ouvert
...
- **Créer un critère** – Enregistrer le critère
